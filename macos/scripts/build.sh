...
if ! command -v swiftc >/dev/null 2>&1; then
  print -u2 -- "swiftc 를 찾지 못했습니다. Xcode 명령줄 도구가 필요합니다:"
...
for skin in spritesheet-angel spritesheet-bee spritesheet-bunny spritesheet-luna spritesheet-rilakkuma spritesheet-rilakkuma-cape; do
